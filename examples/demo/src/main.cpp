...
;            -DESP_WROVER_KIT ; define if you're using the Espressif ESP-WROVER-Devkit 4.1           
*/

// You need a lot of program space/flash space to embed a truetype font
#if (defined(ARDUINO_ARCH_SAMD) && defined(SEEED_GROVE_UI_WIRELESS)) || defined(ARDUINO_ARCH_ESP32)
#define USE_TRUETYPE
#endif
...
#define PIN_NUM_BCKL LCD_BACKLIGHT
#define PIN_NUM_DC LCD_DC
#define PIN_NUM_RST LCD_RESET
...
#endif
#endif
using lcd_type = ili9341<PIN_NUM_DC,PIN_NUM_RST,PIN_NUM_BCKL,bus_type,LCD_ROTATION,LCD_BACKLIGHT_HIGH
