...
namespace arduino {
enum struct ili9341_display_type {
    standard = 0,
    v_variant = 1,
    ili9342c = 2
};
template <int8_t PinDC,
          ...
          ili9341_display_type DisplayType = ili9341_display_type::standard,
    ...
    bool initialize() {
        if (!m_initialized) {
            if (driver::initialize()) {
                ...
                if (display_type == ili9341_display_type::v_variant) {
                ...
                } else if (display_type == ili9341_display_type::ili9342c) {
                    driver::send_command(0xC8);
                    driver::send_data8(0xFF);
                    driver::send_data8(0x93);
                    ...
                    driver::send_command(0xC1);
                    driver::send_data8(0x03);

                    driver::send_command(0xB0);
                    driver::send_data8(0xE0);

                    driver::send_command(0xF6);
                    driver::send_data8(0x00);
                    driver::send_data8(0x01);
                    driver::send_data8(0x01);
                    driver::send_command(0x36);  // Memory Access Control
                    // Rotation 0 (portrait mode)
                    driver::send_data8(0x80 | 0x20 | 0x08);

                    driver::send_command(0x21);  // invert display
                    driver::send_command(0x3A);
                    driver::send_data8(0x55);
                    ...
                    driver::send_data8(0x89);
                    driver::send_data8(0x4C);
                    driver::send_data8(0x06);
                    driver::send_data8(0x0C);
                    driver::send_data8(0x0A);
                    driver::send_data8(0x2E);
                    driver::send_data8(0x34);
                    driver::send_data8(0x0F);
                    ...
                    driver::send_data8(0x11);
                    driver::send_data8(0x05);
                    driver::send_data8(0x13);
                    driver::send_data8(0x09);
                    driver::send_data8(0x33);
                    driver::send_data8(0x67);
    ...
    static void apply_rotation(int rot) {
        ...
        switch (rot&3) {
            ...
            case 2:
                // portrait
                if (display_type == ili9341_display_type::ili9342c) {
                    driver::send_data8(0x20 | 0x40 | 0x08);
                } else {
...
template <int8_t PinDC,
          ...
          uint8_t Rotation,
          bool BacklightHigh,
          ili9341_display_type DisplayType,
          unsigned int WriteSpeedPercent,
          unsigned int ReadSpeedPercent>
int ili9341x<PinDC,
             PinRst,
             PinBL,
             Bus,
...
using ili9341v = ili9341x<PinDC,
                          ...
                          Rotation,
                          BacklightHigh,
                          ili9341_display_type::v_variant,
                          WriteSpeedPercent,
                          ReadSpeedPercent>;
template <int8_t PinDC,
          int8_t PinRst,
          ...
          unsigned int WriteSpeedPercent = 200,
          unsigned int ReadSpeedPercent = WriteSpeedPercent>
using ili9342c = ili9341x<PinDC,
                         PinRst,
                         PinBL,
                         Bus,
                         Rotation,
                         BacklightHigh,
                         ili9341_display_type::ili9342c,
                         WriteSpeedPercent,
                         ReadSpeedPercent>;
template <int8_t PinDC,
          int8_t PinRst,
